...
import { ArrowLeft, Plus, Sparkles, SquareKanban } from "lucide-react";
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-6 text-[#94A3B8] md:text-base">
              {projectName
                ? `Track and manage execution work inside ${projectName}.`
                : "Track and manage execution work for this project."}
            </p>
          </div>
