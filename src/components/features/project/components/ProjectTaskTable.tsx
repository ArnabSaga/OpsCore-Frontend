...
const ProjectTaskTable = ({ tasks, onOpen, onEdit, onDelete }: ProjectTaskTableProps) => {
  return (
    <div
            ...
            <TableRow key={task.id} className="border-white/10 text-white hover:bg-white/5">
              <TableCell className="px-6 py-4">
                <button
                  ...
                  className="max-w-[320px] truncate text-left text-sm font-semibold text-white hover:text-[#CBB5FF]"
                >
                  {task.title}
                </button>
                <p className="mt-1 max-w-[420px] truncate text-xs text-[#94A3B8]">
