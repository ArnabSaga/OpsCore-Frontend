        ...
        <Table>
          <TableHeader>
            <TableRow className="border-white/10 hover:bg-transparent">
              ...
              <TableHead className="whitespace-nowrap text-[#94A3B8]">Project</TableHead>
              ...
              <TableHead className="whitespace-nowrap text-[#94A3B8]">Due</TableHead>
          ...
          <TableBody>
            {tasks.map((task) => (
              <TableRow key={task.id} className="border-white/10 text-white hover:bg-white/5">
                ...
                <TableCell className="whitespace-nowrap text-[#D0D5DD]">
                  {task.project.name}
                </TableCell>
                ...
                <TableCell>
                  <div className="inline-flex items-center gap-2 whitespace-nowrap text-sm text-[#D0D5DD]">
