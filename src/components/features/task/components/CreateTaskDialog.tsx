    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        await mutateAsync({
          ...
          dueDate: parsed.data.dueDate ? toIsoDate(parsed.data.dueDate) : undefined,
        });
      ...
      <DialogContent className="max-w-2xl border-white/10 bg-[#101828] text-white">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Plus className="h-5 w-5 text-[#CBB5FF]" />
            Create task
          </DialogTitle>
          <DialogDescription className="text-[#94A3B8]">
            Create a new project task with backend-aligned validation.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the task scope or expectation"
                  />
                </div>
              </div>
            )}
