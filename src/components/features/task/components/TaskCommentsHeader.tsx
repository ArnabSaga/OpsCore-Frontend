...
type TaskCommentsHeaderProps = {
  task: TaskDetails;
};

const TaskCommentsHeader = ({ task }: TaskCommentsHeaderProps) => {
  return (
    <section
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-6 text-[#94A3B8] md:text-base">
              Collaborate on <span className="font-medium text-white">{task.title}</span> and keep
              task discussion centralized inside OpsCore.
            </p>
          </div>
