...
const featureItems = [
  "Fast resend for expired codes",
  "Secure email-based verification flow",
  "Smooth onboarding for new users",
  "Direct path back to verify email",
];
          ...
          <div className="flex h-dvh items-center">
            <div className="max-w-[520px]">
              ...
              <h1 className="max-w-[11ch] text-[2.5rem] font-bold leading-[0.98] tracking-tight text-white xl:text-[4rem]">
                Request a new verification code and continue your account setup.
              </h1>

              <p className="mt-5 max-w-[540px] text-[15px] leading-7 text-[#94A3B8] xl:text-lg">
                Enter your email address and we’ll send a fresh verification code so you can
                complete activation securely.
              </p>
