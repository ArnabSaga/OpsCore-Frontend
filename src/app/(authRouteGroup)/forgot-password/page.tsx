...
const featureItems = [
  "Fast password recovery flow",
  "Secure email-based reset process",
  "Designed for workspace security",
  "Simple path back into your account",
];
          ...
          <div className="flex h-dvh items-center">
            <div className="max-w-[520px]">
              ...
              <h1 className="max-w-[11ch] text-[2.5rem] font-bold leading-[0.98] tracking-tight text-white xl:text-[4rem]">
                Recover your account access without losing momentum.
              </h1>

              <p className="mt-5 max-w-[540px] text-[15px] leading-7 text-[#94A3B8] xl:text-lg">
                Enter your email address and we&apos;ll send password reset instructions so you can
                securely regain access to OpsCore.
              </p>
