...
const featureItems = [
  "Email verification protects account access",
  "Fast activation for new workspaces",
  "Secure onboarding for every user",
  "Smooth transition into login after success",
];
...
const VerifyEmailPage = () => {
  return (
    <div className="relative h-dvh overflow-hidden bg-[#0B0B0B] text-white">
      ...
      <div className="relative mx-auto grid h-full w-full max-w-[1360px] grid-cols-1 overflow-hidden px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,430px)] lg:gap-8 lg:px-8 xl:grid-cols-[minmax(0,1.05fr)_430px] xl:px-10">
        <div className="hidden h-full lg:block">
          <div className="flex h-dvh items-center">
            <div className="max-w-[520px]">
              ...
              <h1 className="max-w-[11ch] text-[2.5rem] font-bold leading-[0.98] tracking-tight text-white xl:text-[4rem]">
              ...
              <p className="mt-5 max-w-[540px] text-[15px] leading-7 text-[#94A3B8] xl:text-lg">
                We sent a verification code to your email address. Enter it to complete account
                setup and continue securely.
              </p>
