import VerifyEmailForm from "@/components/features/auth/components/VerifyEmailFrom";
        ...
        <div className="hidden flex-col justify-center px-8 py-16 lg:flex xl:px-16">
          <div className="max-w-xl">
            ...
            <p className="mt-5 max-w-lg text-base leading-7 text-[#94A3B8] xl:text-lg">
              We sent a verification code to your email address. Enter it to complete account setup
